...
function TournamentLogo() {
    ...
    const tournamentLogo = teamsData.display.tournamentLogo.startsWith('faceit') ? FACEIT_LOGO : teamsData.display.tournamentLogo ?? DEFAULT_LOGO

    return (
        <img style={{maxHeight: '200px'}} src={tournamentLogo}/>
    )
}
